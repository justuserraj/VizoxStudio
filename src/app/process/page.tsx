          ...
          <div className="container px-6 max-w-7xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 relative mt-20">
              {PROCESSES.map((process, idx) => (
                ...
                >
                  <Card3D intensity={8}>
                    <div className="relative z-10 flex flex-col p-8 rounded-[32px] glass-card h-full transition-all duration-500 hover:border-primary/40">
                      ...
                      <div className="mt-auto space-y-4 pt-6 border-t border-border/30">
                        <div>
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="mt-32 text-center rounded-[24px] glass-card p-12 lg:p-16 relative overflow-hidden"
            >
